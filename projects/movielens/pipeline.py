...
from starter_code.spark_session import get_spark
...
def nettoyage(ratings, movies):
    ...
    # TODO  : compléter le nettoyage ici
    raise NotImplementedError("TODO nettoyage")


def ecrire_silver(ratings_clean):
    """Étape 1c : écrire la couche silver en Parquet."""
    ratings_clean.write.mode("overwrite").parquet(SORTIE_SILVER)
